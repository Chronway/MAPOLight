# **The MAPOLight**
### The official and refined code implementation for the EAAI paper [*"Cooperative traffic signal control for a partially observed vehicular network using multi-agent reinforcement learning"*](https://doi.org/10.1016/j.engappai.2025.111813)
