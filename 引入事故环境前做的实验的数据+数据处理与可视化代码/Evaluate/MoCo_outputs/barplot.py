...
parser.add_argument('-a', '--arch', dest='arch', help='', default=['ppo', 'a3c', 'sac', "fixed_time", "random", "websters", "maxpressure"], nargs='+')
# parser.add_argument('-g', '--graph', dest='graph', help='', default=['line', 'box'])
parser.add_argument('-p', '--path', dest='path', help='', default=["1.0", "0.1", "0.05", "0.2", "fixed", "random", "websters", "maxpressure"], nargs='+')
